<?php
class lapnotamasukxl extends CI_Controller {
	function index()
	{
		...
		,dari,tujuan,keterangan,sifat,isi,perihal,DATE_FORMAT(tgl_disposisi, '%d/%m/%Y') as  tgl_disposisiv,
		tindak_lanjut from nota_masuk
		where

<?
class suratmasukisiamodel extends CI_Model {
	...
	$balik.=form_open_multipart('suratmasuklista/doupload', $attributes);
	$nosuratv="";$txttanggalv=date('d/m/Y');$dariv="";$tgl_masukv=date('d/m/Y');$tujuanv="";$keteranganv="";$sifat_suratv="";$isiv="";
	$disposisiv="";$tgl_disposisiv="";$no_berkasv="";$no_kendaliv="";$tindak_lanjutv="";$options = "";$no_barisv="";$no_rakv="";
	...
	if ($this->input->post('pilihankita'))
	{
	    ...
	    ,a.dari,a.tujuan,a.keterangan,a.sifat_surat,a.isi,a.disposisi,
	    DATE_FORMAT(a.tgl_disposisi, '%d/%m/%Y') as  tgl_disposisiv,a.no_berkas,
	    a.no_kendali,a.tindak_lanjut,b.no_baris,b.no_rak from masuk a left join masuk_dari b on a.nosurat=b.nosurat
		...
		$no_rakv=$row->no_rak;
		$qry="select a.userid,b.nama from masuk_ke a inner join master_user b on a.userid=b.userid
	...
	{
		$qry="select count(*) as jumlah from masuk_dari where no_rak=".
	...
	$qry="select a.no_berkas,a.no_kendali,b.no_rak,b.no_baris from masuk a left join masuk_dari b on a.nosurat=b.nosurat

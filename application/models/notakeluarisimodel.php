<?
class notakeluarisimodel extends CI_Model {
	...
	$balik.=form_open_multipart('notakeluarlist/doupload', $attributes);
	$nonotav="";$txttanggalv=date('d/m/Y');$dariv="";$tujuanv="";$keteranganv="";$isiv="";$txttgl_pengirimanv="";
	...
	$balik.="<tr class=\"alternate\" valign=\"top\"><td>Keterangan</td><td >:</td><td>".form_textarea($data)."</td></tr>";

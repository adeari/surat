...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>notamasuklista">
...
{
	$('dataliat').action='<?=$lincss;?>notamasukisia';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>notamasukdetaila?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+
...
function komentar(isi) {
	window.open ("<?=$lincss;?>komentarnotaa?isi="+encodeURIComponent(isi),"komen","left="+Math.ceil(screen.width/2-500)+",top="+
		     Math.ceil(screen.height/2-300)+",scrollbars=1,menubar=1,resizable=1,width=1000,height=600");
}

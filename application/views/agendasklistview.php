...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>agendasklist">
...
<center><h1><font color="blue">Agenda SK</font></h1></center>
...
<tr class="alternate" valign="top">
	<td rowspan="4"><div align="right"><font color="red" width="95%"><h3>Jumlah Agenda SK</h3></font></div></td>
...
{
	$('dataliat').action='<?=$lincss;?>agendaskisi';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>agendaskdetail?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+

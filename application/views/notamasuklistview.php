...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>notamasuklist">
...
<center><h1><font color="blue">Nota Masuk</font></h1></center>
...
<table class="wp-list-table widefat posts" cellspacing="0">
	...
	<tr>
		...
		<th scope="col" id="tags" class="manage-column column-tags"><a href="#" onClick="orderBy('isi')" >Isi</a></th>
	</tr>
	</thead>
	<tfoot>
	<tr>
...
<tr class="alternate" valign="top">
	<td rowspan="4"><div align="right"><font color="red" width="95%"><h3>Jumlah Nota Masuk</h3></font></div></td>
...
{
	$('dataliat').action='<?=$lincss;?>notamasukisi';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>notamasukdetail?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+

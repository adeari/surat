...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>agendasptlist">
...
<center><h1><font color="blue">Agenda SPT</font></h1></center>
...
<table class="wp-list-table widefat posts" cellspacing="0">
	...
	<th scope="col" id="author" class="manage-column column-author sortable desc"><a href="#" onClick="orderBy('noagenda')" >No.&nbsp;Agenda</a></th>
...
<tr class="alternate" valign="top">
	<td rowspan="4"><div align="right"><font color="red" width="95%"><h3>Jumlah Agenda SPT</h3></font></div></td>
...
{
	$('dataliat').action='<?=$lincss;?>agendasptisi';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>agendasptdetail?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+

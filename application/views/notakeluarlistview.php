...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>notakeluarlist">
...
<tr class="alternate" valign="top">
	<td colspan="2"><div align="right"><font color="red"><h3>Jumlah Nota Keluar = <?=$jumlahIsiData?></h3></font></div></td>
</tr>
...
{
	$('dataliat').action='<?=$lincss;?>notakeluarisi';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>notakeluardetail?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+

...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sampai Tanggal : <input type="text" name="ke" id="ke" size="12" maxlength="10" onFocus="this.setStyle({ background: 'yellow' });MaskedTextBox_NS_FocusMask(event, this.id, '99/99/9999');" onkeyup="date_entry_new(this,event);" onBlur="this.setStyle({ background: 'white' });" onkeypress="return date_input(this.id,this.name,event);" onChange="date_validation(this);"  /><a href="javascript:void(0)" onclick="gfPop.fPopCalendar($('ke'));return false;"><img name="popcal" src="login_files/tgl.gif" align="absmiddle" border="0" height="16" width="16"></a>				
			<br/><br/>
<button name="btreport" type="button" id="btreport" value="DownloadReport" onClick="window.open('lapnotakeluarrepot?dari='+$('dari').value+'&ke='+$('ke').value,'reportmasuk','left='+Math.ceil(screen.width/2-500)+',top='+Math.ceil(screen.height/2-300)+',menubar=1,scrollbars=1,resizable=1,width=1000,height=600');" >Download Report</button>
<button name="btreport" type="button" id="btreport" value="DownloadReport" onClick="window.open('lapnotakeluarxl?dari='+$('dari').value+'&ke='+$('ke').value,'reportmasuk','left='+Math.ceil(screen.width/2-500)+',top='+Math.ceil(screen.height/2-300)+',menubar=1,scrollbars=1,resizable=1,width=1000,height=600');" >Download Excel Report</button>
				</center>
			</div><!-- #content -->
		</div><!-- #primary -->

...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>suratmasuklist">
...
{
	$('dataliat').action='<?=$lincss;?>suratmasukisi';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>suratmasukdetail?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+

...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>suratkeluarlist">
...
<table class="wp-list-table widefat posts" cellspacing="0">
	...
	<tr>
		...
		<th scope="col" id="title" class="manage-column column-title sortable desc" width="5%"><a href="#" onClick="orderBy('no_urut')" >No.</a></th>
...
{
	$('dataliat').action='<?=$lincss;?>suratkeluarisi';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>suratkeluardetail?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+

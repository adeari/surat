...
<form name="dataliat" id="dataliat" method="post" action="<?=$lincss;?>suratmasuklista">
...
<center><h1><font color="blue">Surat Masuk</font></h1></center>
...
<table class="wp-list-table widefat posts" cellspacing="0">
	...
	<tr>
		...
		<th scope="col" id="author" class="manage-column column-author sortable desc"><a href="#" onClick="orderBy('dari')" >Dari</a></th>
...
<tr class="alternate" valign="top">
	<td rowspan="4"><div align="right"><font color="red" width="95%"><h3>Jumlah Surat Masuk</h3></font></div></td>
...
{
	$('dataliat').action='<?=$lincss;?>suratmasukisia';
	$('dataliat').submit();
}
function cari() {
	$('dataliat').halaman.value='0';
...
function detail(isi) {
	window.open ("<?=$lincss;?>suratmasukdetaila?isi="+encodeURIComponent(isi),"mywindow","left="+Math.ceil(screen.width/2-500)+",top="+
		     Math.ceil(screen.height/2-300)+",scrollbars=1,menubar=1,resizable=1,width=1000,height=600");
}

function komentar(isi) {
	window.open ("<?=$lincss;?>komentarsurata?isi="+encodeURIComponent(isi),"komen","left="+Math.ceil(screen.width/2-500)+",top="+
		     Math.ceil(screen.height/2-300)+",scrollbars=1,menubar=1,resizable=1,width=1000,height=600");
}
function ubah(isi)
{
